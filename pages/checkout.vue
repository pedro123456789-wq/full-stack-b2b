...
//check if user has at least one item in the cart
// onBeforeMount(async () => {
...
//once page is loaded sum the prices to get the total to pay
onMounted(async () => {
...
//if total is greater than zero initialise stripe
watch(
  () => total.value,
  () => {
    if (total.value > 0) {
