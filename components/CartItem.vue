...
const props = defineProps(["product", "selectedArray"]); //vue way of defining props for component
...
watch(
  () => isSelected.value,
  (val) => {
    // emit creates a default event handler for the parent of the component
    //by passing @selectedRadio=selectedRadioFunc in shoppingcart.vue, the selectedRadioFunc
    //gets called every time emit is called here, with the dictionary as the argument
